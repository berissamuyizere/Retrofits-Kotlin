...
class NamesRvAdapter(val names: List<String>):RecyclerView.Adapter<NamesViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NamesViewHolder {
       val  itemmView = LayoutInflater.from(parent.context).inflate(R.layout.name_list_item,parent,false)
        return NamesViewHolder(itemmView)
    }
